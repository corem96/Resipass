        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FechaPublicacion = table.Column<DateTime>(nullable: false, defaultValueSql: "GETUTCDATE()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FechaPago = table.Column<DateTime>(nullable: false, defaultValueSql: "GETUTCDATE()"),
                    FechaVencimiento = table.Column<DateTime>(nullable: false, defaultValueSql: "DATEADD(month, 1, GETUTCDATE())"),
                    Importe = table.Column<decimal>(nullable: false, defaultValue: 300m),
                    NumeroFolio = table.Column<string>(nullable: false),
                    NumeroAutorizacion = table.Column<string>(nullable: false),
                    Sucursal = table.Column<string>(nullable: false),
                    Cajero = table.Column<string>(maxLength: 150, nullable: false)
                },
                constraints: table =>
                {
